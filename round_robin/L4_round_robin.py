...
class L4RoundRobin:
    """
    A class representing a round-robin match between two L4 bots' responses.
    
    This class holds a pair of L4 bot instances (which share the same instruction)
    and is tasked with comparing their responses (stored in the attribute `math_block`)
    to decide which response is better. The comparison is done asynchronously using llm_call.
    
    Attributes:
        bot1: The first L4 bot instance.
        bot2: The second L4 bot instance.
    ...
    """
    def __init__(self, bot1: L4Bot, bot2: L4Bot):
        self.bot1 = bot1
        self.bot2 = bot2
        self.result = None
        ...
        self.system_prompt_reasoning = (
            "You are a Level 4 (L4) Evaluation Bot. Your task is to critically assess two "
            "responses generated by L4 bots. First, provide a detailed reasoning about the strengths "
        ...
        self.system_prompt_decision = (
            "You are a Level 4 (L4) Evaluation Bot. Based on the provided reasoning, decide which response is superior. "
    ...
    async def _reason_competition(self):
        ...
        prompt = (
            ...
            f"{self.bot1.L4_instruction}\n\n"

            "MATH BLOCK 1:\n\n"

            f"{self.bot1.math_draft}\n\n"

            "MATH BLOCK 2:\n\n"

            f"{self.bot2.math_draft}\n\n"

            "You have been provided with the responses of two L4 bots above, i.e., "
            "math block 1 and math block 2). Reason about the strengths and weaknesses of " 
            "each in terms of the quality of the mathematics and adherence to the instructions."
            "You can assume that the actual mathematics is correct."
        )
    ...
    async def _final_decision(self):
        ...
        prompt = (
            ...
            "You have been provided with the responses of two L4 bots above, i.e., "
            "math block 1 and math block 2). You just reasoned about the strengths and weaknesses of " 
            "each in terms of the quality of the mathematics and adherence to the instructions."
    ...
    async def step(self):
        ...
        if self.done:
            raise RuntimeError("L4 round robin bot called after being marked done.")
        if self.current_llm_call_index >= len(llm_call_sequence):
            raise RuntimeError("L4 round robin bot invalid call sequence index.")
